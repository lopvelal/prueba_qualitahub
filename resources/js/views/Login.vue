...
<template>
    <section class="bg-gray-50">
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            <router-link to class="flex items-cente">
                <img class="mb-4" src="https://qualitahub.com/wp-content/uploads/QualitaHUB-Logotipo.png" alt="logo">
            </router-link>
            <div class="w-full bg-white rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0">
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form @submit.prevent="authStore.handleLogin(form)" class="space-y-4 md:space-y-6" action="#">
                        ...
                        <button type="submit"
                            class="w-full text-white bg-red-600 hover:bg-white hover:text-red-600 hover:outline-red-600 hover:outline hover:outline-solid focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Sign
                            in</button>
                    </form>
                </div>
            </div>
